...
const nddVehicleData = [
  { icon: 'tabler-car', title: 'Em Rota', time: '2h 10min', percentage: 39.7 },
  { icon: 'tabler-circle-arrow-down', title: 'Descarregando', time: '3h 15min', percentage: 28.3 },
  { icon: 'tabler-circle-arrow-up', title: 'Carregando', time: '1h 24min', percentage: 17.4 },
  { icon: 'tabler-clock', title: 'Aguardando', time: '5h 19min', percentage: 14.6 },
]
</script>

<template>
  <VCard>
    <VCardItem title="Overview de Entregas">
      <template #append>
        <MoreBtn />
      </template>
    </VCardItem>
    <VCardText>
      ...
      <VTable class="text-no-wrap">
        <tbody>
          <tr
            v-for="(vehicle, index) in nddVehicleData"
            :key="index"
          >
            <td
              width="70%"
