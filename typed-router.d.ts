...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'alterar-senha': RouteRecordInfo<'alterar-senha', '/alterar-senha', Record<never, never>, Record<never, never>>,
    ...
    'compra-viagem': RouteRecordInfo<'compra-viagem', '/compra-viagem', Record<never, never>, Record<never, never>>,
    'compra-viagem-id': RouteRecordInfo<'compra-viagem-id', '/compra-viagem/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'compra-viagem-components-compra-viagem-mapa-fixo': RouteRecordInfo<'compra-viagem-components-compra-viagem-mapa-fixo', '/compra-viagem/components/CompraViagemMapaFixo', Record<never, never>, Record<never, never>>,
    'compra-viagem-components-compra-viagem-step1-pacote': RouteRecordInfo<'compra-viagem-components-compra-viagem-step1-pacote', '/compra-viagem/components/CompraViagemStep1Pacote', Record<never, never>, Record<never, never>>,
    'compra-viagem-components-compra-viagem-step2-placa': RouteRecordInfo<'compra-viagem-components-compra-viagem-step2-placa', '/compra-viagem/components/CompraViagemStep2Placa', Record<never, never>, Record<never, never>>,
    'compra-viagem-components-compra-viagem-step3-rota': RouteRecordInfo<'compra-viagem-components-compra-viagem-step3-rota', '/compra-viagem/components/CompraViagemStep3Rota', Record<never, never>, Record<never, never>>,
    'compra-viagem-components-compra-viagem-step4-preco': RouteRecordInfo<'compra-viagem-components-compra-viagem-step4-preco', '/compra-viagem/components/CompraViagemStep4Preco', Record<never, never>, Record<never, never>>,
    'compra-viagem-components-compra-viagem-step5-confirmacao': RouteRecordInfo<'compra-viagem-components-compra-viagem-step5-confirmacao', '/compra-viagem/components/CompraViagemStep5Confirmacao', Record<never, never>, Record<never, never>>,
    'compra-viagem-index-new': RouteRecordInfo<'compra-viagem-index-new', '/compra-viagem/index-new', Record<never, never>, Record<never, never>>,
    'compra-viagem-nova': RouteRecordInfo<'compra-viagem-nova', '/compra-viagem/nova', Record<never, never>, Record<never, never>>,
    'compra-viagem-nova-old-backup': RouteRecordInfo<'compra-viagem-nova-old-backup', '/compra-viagem/nova-old-backup', Record<never, never>, Record<never, never>>,
    'configurar-senha-token': RouteRecordInfo<'configurar-senha-token', '/configurar-senha/:token', { token: ParamValue<true> }, { token: ParamValue<false> }>,
    ...
    'perfis': RouteRecordInfo<'perfis', '/perfis', Record<never, never>, Record<never, never>>,
    ...
    'rotas-padrao-nova': RouteRecordInfo<'rotas-padrao-nova', '/rotas-padrao/nova', Record<never, never>, Record<never, never>>,
    ...
    'test-leaflet': RouteRecordInfo<'test-leaflet', '/test-leaflet', Record<never, never>, Record<never, never>>,
    'test-leaflet-pacote': RouteRecordInfo<'test-leaflet-pacote', '/test-leaflet-pacote', Record<never, never>, Record<never, never>>,
    'test-ors-simple': RouteRecordInfo<'test-ors-simple', '/test-ors-simple', Record<never, never>, Record<never, never>>,
    ...
    'vpo-emissao-components-vpo-step4-rota': RouteRecordInfo<'vpo-emissao-components-vpo-step4-rota', '/vpo-emissao/components/VpoStep4Rota', Record<never, never>, Record<never, never>>,
    'vpo-emissao-components-vpo-step5-confirmacao': RouteRecordInfo<'vpo-emissao-components-vpo-step5-confirmacao', '/vpo-emissao/components/VpoStep5Confirmacao', Record<never, never>, Record<never, never>>,
    'vpo-emissao-nova': RouteRecordInfo<'vpo-emissao-nova', '/vpo-emissao/nova', Record<never, never>, Record<never, never>>,
